...
router.post('/growin/create', async (req, res) => {
    try {
        ...
        const paymentData = {
            ...
            cancelUrl: `https://www.fashionweektelaviv.com/checkout/cancel?bookingId=${booking.id}`,
            successUrl: `https://www.fashionweektelaviv.com/checkout/success?bookingId=${booking.id}`,
